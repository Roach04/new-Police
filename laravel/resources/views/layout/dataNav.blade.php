    ...
    <nav style="background-color:black" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                @if(Auth::check())
                	<a class="navbar-brand page-scroll" href=" {{ URL::to('dataOperator/dashboard')}} ">

                        <span style="color:#f44336"> Data Operator. </span>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(Auth::check())    
                        <li> 
                            <a href=" {{ URL::route('assets') }} ">
                                <i class="fa fa-bus fa-2x"> </i>
                                Assets. 
                            </a> 
                        </li>
                        <li> 
                            <a href=" {{ URL::route('createClient') }} ">
                                <i class="fa fa-user-plus fa-2x"> </i>
                                Clients. 
                            </a> 
                        </li>
                        <li> 
                            <a href=" {{ URL::route('serviceProvider') }} ">
